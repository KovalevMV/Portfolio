...
| 3.  | [Анализ текстов]([https://Portfolio/tree/main/Analyzing%20Texts](https://github.com/KovalevMV/Portfolio/blob/main/Taxi%20ordering/README.md)) | Анализ комментариев пользователей на токсичность  | python, pandas, numpy, nltk, sklearn, CatBoost | ***Машинное обучение (DA, DS) |
